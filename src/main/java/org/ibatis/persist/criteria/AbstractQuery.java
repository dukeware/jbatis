 ...
 *
 * <p>
 * All queries must have: a set of root entities.
 * <p>
...
public interface AbstractQuery<T> extends CommonAbstractCriteria {
    ...
    /**
     * Modify the query to restrict the query results according to the specified boolean expression. Replaces the
     ...
     * predicates. Replaces the previously having added restriction(s), if any. If no restrictions are specified, any
     * previously added restrictions are simply removed.
     * 
     * @param restrictions
     *            zero or more restriction predicates
    ...
    /**
     * Return the query roots. These are the roots that have been defined for the <code>CriteriaQuery</code> or
     * <code>Subquery</code> itself, including any subquery roots defined as a result of correlation. Returns empty set
     * if no roots have been defined. Modifications to the set do not affect the query.
     * 
    ...
    /**
     * Return a list of the grouping expressions. Returns empty list if no grouping expressions have been specified.
     ...
     * <code>createQuery</code> or <code>subquery</code> method, that type will be returned. If the query was created
     * using the <code>createTupleQuery</code> method, the result type is <code>Tuple</code>. Otherwise, the result type
     * is <code>Object</code>.
     * 
     * @return result type
     */
