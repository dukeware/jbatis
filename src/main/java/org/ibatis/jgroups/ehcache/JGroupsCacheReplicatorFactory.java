...
public class JGroupsCacheReplicatorFactory extends CacheEventListenerFactory {
    ...
    public CacheEventListener createCacheEventListener(Properties properties) {
        ...
        boolean replicatePuts = extractBooleanProperty(properties, REPLICATE_PUTS, false); // ## sunsong
        boolean replicateUpdates = extractBooleanProperty(properties, REPLICATE_UPDATES, false); // ## sunsong
