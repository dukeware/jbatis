...
public class DbcpConfiguration {
     ...
     */
    public DbcpConfiguration(Map<Object,Object> properties) {
        try {
    ...
    private BasicDataSource newDbcpConfiguration(Map<Object,Object> map) {
    ...
    private BasicDataSource legacyDbcpConfiguration(Map<Object,Object> map) {
