...
public class Resources extends Object {
    ...
    public static InputStream getResourceAsStream(ClassLoader loader, String resource) throws IOException {
        ...
        // ## loader
        if (in == null)
            in = Resources.class.getResourceAsStream(resource);
        if (in == null)
    ...
    static Properties ini;
    public static Properties getIbatisIniProperties() {
        if (ini == null) {
            try {
                ini = getResourceAsProperties("/ibatis.ini");
            } catch (IOException e) {
            }
        }
