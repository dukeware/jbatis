...
public interface SqlMapClient extends SqlMapExecutor, SqlMapTransactionManager {
     ...
     * executing statements, and therefore overrides any configured datasources. Using this approach allows the
     * developer to easily use an externally supplied connection for executing statements.
     * <p/>
     ...
     *
     * @param entityClass
     *            The entity class object to flush cache
     */
