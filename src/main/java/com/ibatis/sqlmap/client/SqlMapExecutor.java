...
import org.ibatis.client.SqlMapExecutor2;
import org.ibatis.persist.EntityManager;
...
public interface SqlMapExecutor extends SqlMapExecutor2, EntityManager {
     ...
     *             If an error occurs.
     */
    <T> T insert(String id, Object parameterObject) throws SQLException;
     ...
     *             If an error occurs.
     */
    <T> T insert(String id) throws SQLException;
     ...
     */
    <T> T queryForObject(String id, Object parameterObject) throws SQLException;
     ...
     *             If more than one result was found, or if any other error occurs.
     */
    <T> T queryForObject(String id) throws SQLException;
     ...
     *             If more than one result was found, or if any other error occurs.
     */
    <T> T queryForObject(String id, Object parameterObject, Object resultObject) throws SQLException;
     ...
     *             If an error occurs.
     */
    <T> List<T> queryForList(String id, Object parameterObject) throws SQLException;
     ...
     *             If an error occurs.
     */
    <T> List<T> queryForList(String id) throws SQLException;
     ...
     *             If an error occurs.
     */
    <T> List<T> queryForList(String id, Object parameterObject, int skip, int max) throws SQLException;
     ...
     *             If an error occurs.
     */
    <T> List<T> queryForList(String id, int skip, int max) throws SQLException;
     ...
     *             If an error occurs.
     */
    <T> int queryForPage(List<T> page, String id, Object paramObject, int skip, int max) throws SQLException;
     ...
     *             If an error occurs.
     */
    <T> int queryForPage(List<T> page, String id, int skip, int max) throws SQLException;
     ...
     *             If an error occurs.
     */
    <K, V> Map<K, V> queryForMap(String id, Object parameterObject, String keyProp) throws SQLException;
     ...
     *             If an error occurs.
     */
    <K, V> Map<K, V> queryForMap(String id, Object parameterObject, String keyProp, String valueProp)
        throws SQLException;
     ...
     *            The property to be used as the key in the Map.
     * @param keyType
     *            The type of property to be used as the key in the Map.
     * @param valueProp
     *            The property to be used as the value in the Map.
     * @param valueType
     *            The type of property to be used as the value in the Map.
     * @return A Map keyed by keyProp with values of valueProp.
     * @throws java.sql.SQLException
     *             If an error occurs.
     */
    <K, V> Map<K, V> queryForMap(String id, Object parameterObject, String keyProp, Class<K> keyType, String valueProp,
     ...
     * improve overall performance of updates update when dealing with numerous updates (e.g. inserting 1:M related
     * data).
     *
     * @param batchSize
     *            if > 0 and batchSize reached, then flush the batch.
     * @throws java.sql.SQLException
     *             If the batch could not be started.
     */
    void startBatch(int batchSize) throws SQLException;
     ...
     */
    List<BatchResult> executeBatchDetailed() throws SQLException, BatchException;
}
