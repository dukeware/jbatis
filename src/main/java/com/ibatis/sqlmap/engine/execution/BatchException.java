...
public class BatchException extends Exception {
     ...
     * serialVersionUID
     */
    private static final long serialVersionUID = -4432192170032748869L;
    private List<BatchResult> successfulBatchResults;
    private BatchUpdateException batchUpdateException;
    private String failingSqlStatement;
    private String failingStatementId;

    public BatchException(String message, BatchUpdateException cause, List<BatchResult> successfulBatchResults,
