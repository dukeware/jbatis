...
public class PropertyAccessPlan extends BaseAccessPlan {
    ...
    public void setProperties(Object object, Object[] values) {
        ...
        try {
            ...
            throw new RuntimeException("Error setting property '" + setters[i].getAccessName() + "' of '" + object
                + "'.  Cause: " + t, t);
        }
    }
    ...
    public Object[] getProperties(Object object) {
        ...
        try {
            ...
            throw new RuntimeException("Error getting property '" + getters[i].getAccessName() + "' of '" + object
                + "'.  Cause: " + t, t);
        }
        return values;
    }
