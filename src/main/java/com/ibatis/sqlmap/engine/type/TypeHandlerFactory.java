...
public class TypeHandlerFactory {
    ...
    private final Map<Class<?>, Map<String, TypeHandler<?>>> typeHandlerMap = new HashMap<Class<?>, Map<String, TypeHandler<?>>>();
    private final TypeHandler<?> unknownTypeHandler = new UnknownTypeHandler(this);
    private final HashMap<String, String> typeAliases = new HashMap<String, String>();

    private static final Map<Class<?>, Class<?>> reversePrimitiveMap = new HashMap<Class<?>, Class<?>>() {
        /**
         * serialVersionUID
         */
        private static final long serialVersionUID = 1025691390656976714L;
    ...
    public TypeHandlerFactory() {
        ...
        // ## sunsong - like
        putTypeAlias("_like_", String_Like_TypeHandler.class.getName());
        putTypeAlias("_like", String_LikeTypeHandler.class.getName());
        putTypeAlias("like_", StringLike_TypeHandler.class.getName());
    }
    ...
    public void putTypeAlias(String alias, String value) {
        ...
        if (typeAliases.containsKey(key) && !typeAliases.get(key).equals(value)) {
            throw new SqlMapException("Error in SqlMapClientBuilder.  Alias name conflict occurred.  The alias '" + key
