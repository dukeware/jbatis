...
public class String_LikeTypeHandler extends StringTypeHandler implements ValueHandler<String> {
    public static final TypeHandler<String> INSTANCE = new String_LikeTypeHandler();
